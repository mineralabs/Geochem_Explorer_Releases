# GeoChem Explorer Releases

Public release downloads for GeoChem Explorer, a desktop app for visualising and analysing drillhole and surface geochemistry projects.

This repository is used for installers, user guides, and release notes. The application source code is not distributed from this repository.
